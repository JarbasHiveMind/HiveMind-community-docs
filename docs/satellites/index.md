...
- [`README.md`](https://github.com/JarbasHiveMind/hivemind-esp32-client/blob/HEAD/README.md) — ESP32 satellite tier (experimental, not yet tested on real hardware)
- [`README.md`](https://github.com/JarbasHiveMind/hivemind-micropython-client/blob/HEAD/README.md) — MicroPython satellite tier (experimental, not yet tested on real hardware)
