...
[OpenVoiceOS](https://openvoiceos.github.io/beta-technical-manual) install, and every satellite
...
See the [OVOS documentation](https://openvoiceos.github.io/beta-technical-manual) for a complete OVOS setup guide.
